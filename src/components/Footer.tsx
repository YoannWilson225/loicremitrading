      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-1 md:col-span-2">
            ...
            >
              Faites partie des 1%, rejoignez le cercle des élites. Plus de 500
              traders formés avec succès.
            </p>
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/share/17MoY6fJV3/?mibextid=wwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/loic_remy_yao?igsh=a2NsZmFkam4xMmhq&utm_source=qr"
                target="_blank"
                rel="noopener noreferrer"
                className={`text-${
                  theme === "dark" ? "gray-400" : "gray-600"
              ...
              <a
                href="www.tiktok.com/@loicremy06"
                target="_blank"
                rel="noopener noreferrer"
                className={`text-${
                  theme === "dark" ? "gray-400" : "gray-600"
              ...
              <a
                href="https://snapchat.com/t/0h7yiTAW"
                target="_blank"
                rel="noopener noreferrer"
                className={`text-${
                  theme === "dark" ? "gray-400" : "gray-600"
              ...
              <a
                href="https://wa.me/2250160251477"
                target="_blank"
                rel="noopener noreferrer"
                className={`text-${
                  theme === "dark" ? "gray-400" : "gray-600"
              ...
              >
                <svg
                  ...
                  aria-hidden="true"
                >
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.472-.149-.67.15-.198.297-.767.966-.94 1.164-.173.198-.347.223-.644.074-.297-.149-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.297-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.372-.025-.521-.075-.148-.669-1.611-.916-2.206-.242-.579-.487-.501-.669-.51l-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.095 3.2 5.077 4.487.709.306 1.262.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347M12.049 21.785h-.003a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26C2.166 6.44 6.6 2.006 12.052 2.006c2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.993c-.003 5.45-4.437 9.884-9.884 9.884Z" />
                  {/* <path d="M20.52 3.449A11.815 11.815 0 0012.045 0C5.495 0 .554 4.942.551 11.493c0 2.027.531 4.009 1.538 5.759L.057 24l6.992-1.833a11.9 11.9 0 005.006 1.163h.005c6.55 0 11.49-4.942 11.494-11.494a11.41 11.41 0 00-3.035-8.387Z" /> */}
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            <h4
              className={`font-bold text-lg mb-4 text-${
                theme === "dark" ? "white" : "gray-900"
              }`}
            >
              Liens rapides
          ...
          <div>
            ...
            <ul className={`space-y-3 ${textColor}`}>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="leading-none">+225 01 41 33 35 97</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="leading-none">9:00 – 20:00 GMT</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div
          ...
          } pt-8 text-center text-${
            theme === "dark" ? "gray-400" : "gray-600"
          }`}
        >
          <p>
            © {new Date().getFullYear()} Loïc Rémy Trading. Tous droits
            réservés.
          </p>
