...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[#A49C91]/20 dark:bg-gray-900"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fadeInLeft">
            <h1 className="text-5xl md:text-6xl font-bold leading-tight">
              <span className="text-gray-900 dark:text-white">
                Intégrez le cercle des{" "}
              </span>
              {/* <br /> */}
              <span className="bg-gradient-to-r from-[#2563EB] via-[#7C3AED] to-[#EF4444] bg-clip-text text-transparent">
                {" "}
                traders d’élite
              </span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
              Apprenez le trading avec une méthode simple et professionnelle.
              Plus de 500 traders formés avec succès.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#formations"
                className="bg-[#005CD9] text-white px-8 py-4 rounded-full text-center font-semibold
             transition-all transform hover:scale-105 shadow-lg hover:shadow-xl
             hover:bg-gradient-to-r hover:from-[#2563EB] hover:via-[#7C3AED] hover:to-[#EF4444]
            ...
            <div className="flex gap-8 pt-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-md card-hover animate-fadeInUp animate-delay-200">
                <div className="text-4xl font-bold text-[#005CD9] dark:text-blue-400">
                  +500
                </div>
          ...
          <div className="relative animate-fadeInRight">
            ...
            <div
              className="absolute -bottom-4 -left-4 w-72 h-72 bg-[#A49C91]/30 dark:bg-[#A49C91]/20 rounded-full blur-3xl animate-pulse"
